...
export default function PrivacyPolicy() {
  return (
    <div className="bg-black text-gray-200 min-h-screen">
      <Head>
        <title>Monet Work - Privacy Policy</title>
      ...
      <main className="container mx-auto max-w-6xl  px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Welcome to Monet Work Information Technology Consultants&apos;s
            privacy policy.
          </p>
          <p className="mb-4">
            Monet Work Information Technology Consultants respects your privacy
          ...
          <p className="mb-4">
            Please use the Glossary to understand the meaning of some of the
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This privacy policy aims to give you information on how Monet Work
            Information Technology Consultants collects and processes your
            personal data through your use of this website, including any data
            you may provide through this website when you sign up to our
          ...
          <p className="mb-4">
            This privacy policy is issued on behalf of all companies in the
            Monet Work Information Technology Consultants Group from time to
            time so when we mention Monet Work Information Technology
            Consultants, <strong>we</strong>, <strong>us</strong> or{" "}
            <strong>our</strong> in this privacy policy, we are referring to the
            relevant company in the Monet Work Information Technology
            Consultants Group responsible for processing your data. Monet Work
            Information Technology Consultants is the controller and responsible
            for this website.
          </p>
          <p className="mb-4">
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              <strong>Full name of legal entity:</strong> Monet Work Information
              Technology Consultants
            </li>
            <li>
              <strong>Email address:</strong> hello@monet.work
            </li>
            <li>
              <strong>Postal address:</strong> C-202, C Wing, Al Saaha Offices,
              Downtown, Dubai, United Arab Emirates
            </li>
          </ul>
          <p className="mb-4">
            If you are concerned about our handling of your personal
            information, you can lodge a complaint with a privacy supervisory
            authority. In the European Economic Area, the relevant supervisory
          ...
          <p className="mb-4">
            A list of National Data Protection Authorities in the European
            Economic Area can be found here:{" "}
            <a
          ...
          <p className="mb-4">
            We would appreciate the chance to deal with your concerns before you
            approach the relevant privacy supervisory authority, so please
          ...
          <p className="mb-4">
            ...
            last reviewed and updated on 15 July 2024.
          </p>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            an individual from which that person can be identified (either
            directly or indirectly). It does not include data where the identity
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              <strong className="text-yellow-400">Profile Data</strong> includes
              your username and password, purchases or orders made by you, your
              interests, preferences, feedback and survey responses;
            </li>
            <li>
              <strong className="text-yellow-400">Usage Data</strong> includes
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              <strong className="text-yellow-400">Direct interactions.</strong>{" "}
            ...
            <li>
              ...
              Please see our Cookie Notice privacy.monet.work for further
              details.
            </li>
            <li>
              <strong className="text-yellow-400">
          ...
          <p className="mb-4">
            <strong className="text-yellow-400">Technical Data</strong> from the
            following parties:
          </p>
          <ul className="list-disc list-inside mb-4">
            <li>analytics providers such as Google based outside the EU;</li>
            <li>advertising networks based inside and outside the EU; and</li>
            <li>
          ...
          <p className="mb-4">
            ...
            from providers of technical, payment and delivery services based
          ...
          <p className="mb-4">
            ...
            from data brokers or aggregators based inside and outside the EU.
          </p>
          <p className="mb-4">
            <strong className="text-yellow-400">
              Identity and Contact Data
            </strong>{" "}
            from publicly available sources such as the Companies House and the
        ...
        <section className="mb-8">
            ...
            <table className="w-full mb-4">
              <thead>
                <tr className="bg-yellow-400 text-black">
                  <th className="p-2 text-left">Purpose/Activity</th>
                  <th className="p-2 text-left">Type of data</th>
              ...
              <tbody>
                <tr>
                  <td className="p-2 border-b border-yellow-400">
          ...
          <h4 className="text-xl font-semibold text-yellow-400 mb-2 mt-6">
            Marketing
          </h4>
          <p className="mb-4">
          ...
          <p className="mb-4">
            A cookie is a small text file which is placed onto your device when
            you access our website. We use cookies and other online tracking
            devices to make your online experience more efficient and enjoyable.
            ...
            about the cookies we use, please see our Cookie Notice
            privacy.monet.work.
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            the purposes set out in the table above in the{" "}
            <strong>Purposes for which we will use your Personal Data</strong>{" "}
            section.
          </p>
          <ul className="list-disc list-inside mb-4">
            <li>
              Internal Third Parties: companies in the Monet Work Information
              Technology Consultants Group;
            </li>
            <li>
              External Third Parties: including service providers and
              professional advisors to Monet Work Information Technology
              Consultants Group;
            </li>
            <li>
            ...
            <li>
              any other third party if we are under a duty to disclose or share
              your personal data to comply with any legal obligation, or to
              protect the rights, property and or safety of Monet Work
              Information Technology Consultants, our personnel or others; and
            </li>
            <li>
              any other third party for the purposes of acting in accordance
              with the requirements of a court, regulator or government agency,
              for example complying with a search warrant or court order or
              acting in accordance with an applicable law or regulation.
            </li>
          </ul>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            We share your personal data within the Monet Work Information
            Technology Consultants Group. This may involve transferring your
            data outside the European Economic Area (<strong>EEA</strong>).
          </p>
          <p className="mb-4">
            Our external third parties may be based outside the EEA so their
            processing of your personal data may involve a transfer of data
            outside the EEA.
          </p>
          <p className="mb-4">
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              and the US. For further details, see{" "}
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            unauthorised third parties, to intercept or access transmissions or
            ...
            your own risk. If you believe that your interaction with us is no
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Whilst we continue to process your personal data we will ensure that
            it is treated in accordance with this privacy policy. Otherwise, we
            securely erase your information once it is no longer needed.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside  flex flex-col gap-4 mb-4">
            <li>
            ...
            <li>
              ...
              personal data to comply with local law. Note that we may not
            ...
            <li>
              ...
              <ul>
                <li> - where you want us to establish the data’s accuracy;</li>
                <li>
                  {" "}
          ...
          <p className="mb-4">
            You will not ordinarily have to pay a fee to access your personal
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            <strong className="text-yellow-400">Legitimate Interest</strong>{" "}
          ...
          <p className="mb-4">
            <strong className="text-yellow-400">Performance of Contract</strong>{" "}
